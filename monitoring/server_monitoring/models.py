...
class Server(db.Model):
    ...
    username = db.Column(db.LargeBinary, nullable=False)  # Store encrypted username as binary
    password = db.Column(db.LargeBinary, nullable=False)  # Store encrypted password as binary
